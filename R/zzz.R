...
"
  ...
  packageStartupMessage(
    paste0(
      banner,
      "\nWelcome to EchoGO — a toolkit for robust, cross-species functional enrichment analysis.",
      "\nHow to cite: Escobar-Sierra C., Langschied F., Inostroza P.A., et al. (2025). EchoGO.",
...
.onLoad <- function(...) {
  ...
  op.echogo <- list(
    ...
    # ---- per-user demo target (used by echogo_quickstart) ----
